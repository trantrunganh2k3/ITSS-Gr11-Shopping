...
public class GroupControllerDB {
    ...
    public static boolean deleteGroup(int groupID) throws ClassNotFoundException, SQLException {
        String sql = "DELETE FROM public.\"Group\" WHERE \"groupID\" = ?";
        Connection conn = DBConnection.getDBConnection().getConnection();
        PreparedStatement stm = conn.prepareStatement(sql);
        stm.setInt(1, groupID);
